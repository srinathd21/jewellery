...
<a href="supplier-payment.php" class="btn btn-light btn-sm"><i class="fa-solid fa-money-bill-transfer me-2"></i>Supplier Payments</a>
...
<?php if($canUpdate && (float)$p['balance_amount'] > 0): ?>
<a class="action-btn pay" href="supplier-payment.php?purchase_id=<?php echo (int)$p['id']; ?>&supplier_id=<?php echo (int)$p['supplier_id']; ?>" title="Pay Supplier"><i class="fa-solid fa-indian-rupee-sign"></i></a>
<?php endif; ?>

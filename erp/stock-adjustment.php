...
:root{--primary:<?php echo h($theme['primary_color']); ?>;--primary-dark:<?php echo h($theme['primary_dark_color']); ?>;--primary-soft:<?php echo h($theme['primary_soft_color']); ?>;--page-bg:<?php echo h($theme['page_background']); ?>;--card-bg:<?php echo h($theme['card_background']); ?>;--text-color:<?php echo h($theme['text_color']); ?>;--muted-color:<?php echo h($theme['muted_text_color']); ?>;--border-color:<?php echo h($theme['border_color']); ?>;--radius:<?php echo (int)$theme['border_radius_px']; ?>px;--sidebar-width:<?php echo (int)$theme['sidebar_width_px']; ?>px}body{background:var(--page-bg);color:var(--text-color);font-family:<?php echo json_encode($theme['font_family']); ?>,sans-serif}.sidebar{background:linear-gradient(180deg,<?php echo h($theme['sidebar_gradient_1']); ?>,<?php echo h($theme['sidebar_gradient_2']); ?>,<?php echo h($theme['sidebar_gradient_3']); ?>)!important}.page-head,.panel,.stat-card{background:var(--card-bg);border:1px solid var(--border-color);border-radius:var(--radius)}.page-head{padding:12px 14px;margin-bottom:10px;display:flex;justify-content:space-between;gap:12px;align-items:center}.page-title{font:800 18px <?php echo json_encode($theme['heading_font_family']); ?>,serif}.page-sub,.muted{font-size:10px;color:var(--muted-color)}.stat-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-bottom:10px}.stat-card{padding:12px}.stat-label{font-size:10px;color:var(--muted-color)}.stat-value{font-size:20px;font-weight:800;margin-top:4px}.panel{padding:14px;margin-bottom:10px}.panel-title{font-size:13px;font-weight:800;margin-bottom:12px}.form-control,.form-select{font-size:11px;min-height:36px;border-radius:9px;border-color:var(--border-color)}.btn-theme{background:linear-gradient(135deg,var(--primary),var(--primary-dark));color:#fff;border:0;border-radius:9px;font-size:11px;font-weight:700;padding:9px 14px}.table{font-size:10px;margin:0}.table th{color:var(--muted-color);text-transform:uppercase;font-size:9px}.stock-detail{display:grid;grid-template-columns:1fr 1fr;gap:8px}.detail{padding:10px;border:1px solid var(--border-color);border-radius:9px}.detail b{display:block;font-size:14px;margin-top:3px}.theme-toast{position:fixed;right:18px;top:78px;z-index:20000;padding:11px 14px;border-radius:10px;color:#fff;font-size:11px;font-weight:600;opacity:0;transform:translateY(-10px);transition:.2s}.theme-toast.show{opacity:1;transform:none}.theme-toast-success{background:#168449}.theme-toast-error{background:#c0392b}@media(max-width:991px){.stat-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:767px){.page-head{align-items:stretch;flex-direction:column}.stat-grid{grid-template-columns:1fr 1fr}.stock-detail{grid-template-columns:1fr}.content-wrap{padding-left:10px;padding-right:10px}}
</style></head><body><?php include('includes/sidebar.php'); ?><main class="app-main"><?php include('includes/nav.php'); ?><div class="content-wrap">
<div class="page-head"><div><div class="page-title">Stock Adjustment</div><div class="page-sub">Add, subtract, or set product stock manually</div></div><div class="d-flex gap-2 flex-wrap"><a class="btn btn-light btn-sm" href="stock-overview.php">Overview</a><a class="btn btn-light btn-sm" href="stock-movements.php">Movements</a></div></div>
<?php if(!$canView): ?><div class="panel text-center muted">You do not have permission to view stock adjustment.</div><?php else: ?>
<div class="stat-grid"><div class="stat-card"><div class="stat-label">Products</div><div class="stat-value"><?php echo count($products); ?></div></div><div class="stat-card"><div class="stat-label">Recent Adjustments</div><div class="stat-value"><?php echo count($recentAdjustments); ?></div></div><div class="stat-card"><div class="stat-label">Selected Qty</div><div class="stat-value"><?php echo number_format((float)($selectedProduct['closing_qty']??0),3); ?></div></div><div class="stat-card"><div class="stat-label">Selected Weight</div><div class="stat-value"><?php echo number_format((float)($selectedProduct['closing_weight']??0),3); ?></div></div></div>

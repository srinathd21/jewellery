...
<head>
    ...
    <style>
        ...
        .number-card[data-key="non_gst_invoice"] {
            border-color: color-mix(in srgb, #168449 42%, var(--line));
            background: color-mix(in srgb, #168449 4%, var(--card-bg));
        }

        .number-card[data-key="non_gst_invoice"] h6 {
            color: #168449;
        }
...
<body><?php include('includes/sidebar.php'); ?>
    <main class="app-main"><?php include('includes/nav.php'); ?>
        <div class="content-wrap">
            ...
            <div class="page-card">
                <div class="card-head">
                    <div><div class="card-title">Document Numbering</div><div class="small text-muted">GST Invoice, Non-GST Invoice and Estimate use separate independent sequences.</div></div>
                </div>
                <div class="card-body">
